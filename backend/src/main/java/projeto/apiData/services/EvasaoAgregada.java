...
public class EvasaoAgregada {
    ...
    private final Double totalDesistentes;
    private final long totalIngressantes;

    public EvasaoAgregada(Double totalDesistentes, Long totalIngressantes) {
        this.totalDesistentes = totalDesistentes != null ? totalDesistentes : 0.0;
    ...
    public Double getTotalDesistentes() { return totalDesistentes; }
